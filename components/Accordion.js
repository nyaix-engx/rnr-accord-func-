...
const Accordion = () => {
  ...
  let heightRow1 = new Value(Height * 0.07);
  let heightRow2 = new Value(Height * 0.07);
  let heightRow3 = new Value(Height * 0.07);

  const toggleRow1Content = () => {
    // console.log('Height before', heightRow1);
    if (!showContent1) {
      heightRow1 = runTiming(new Clock(), new Value(50), new Value(200));
      // console.log('Height after', heightRow1);
    } else {
      heightRow1 = runTiming(new Clock(), new Value(200), new Value(50));
    }
    if (showContent2) {
      heightRow2 = runTiming(new Clock(), new Value(200), new Value(50));
    }
    if (showContent3) {
      heightRow3 = runTiming(new Clock(), new Value(200), new Value(50));
    }

    setShowContent1(!showContent1), setShowContent2(false);
    setShowContent3(false);
  };

  const toggleRow2Content = () => {
    if (!showContent2) {
      heightRow2 = runTiming(new Clock(), new Value(50), new Value(200));
    } else {
      heightRow2 = runTiming(new Clock(), new Value(200), new Value(50));
    }
    if (showContent1) {
    ...
    setShowContent1(false), setShowContent2(!showContent2);
    setShowContent3(false);
  };

  const toggleRow3Content = () => {
    if (!showContent3) {
      heightRow3 = runTiming(new Clock(), new Value(50), new Value(200));
    } else {
      heightRow3 = runTiming(new Clock(), new Value(200), new Value(50));
    }
    if (showContent1) {
    ...
    setShowContent1(false), setShowContent2(false);
